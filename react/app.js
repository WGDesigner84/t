(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        ...
        $(document).ready(function() {
            ...
            var chat_messages = ["Awesome,its rare to find working generator like this one", "Anyone tried this already?", "Does it work in AU?", "Why this is so easy lol?", "This is incredible, never thought it would work.", "I tried for the lowest 0.01btc and received it in a minute.", "shy i see survey ?", "its to protect from spamming, first try to use, i got no Survey request, but for second try i need to get Finish 1 Survey", "OMG!", "LOL!", "ROFL!", "Real", "gayyyy", "easy", "bro", "What can I do here?", "Shut up man I love this website", "hi guys", "How much bitcoins you've generated so far?", "what about surveys on mobile phone?", "Is this free?", "How long do you have to wait?", "Yea", "No", "I know", "Exactly why this is so good", "uhm", "maybe", "I can imagine this must be annoying for the one who play with skill", "Is this ban secure?", "Thanks man I appreciate this.", "Cool =)", "<message deleted>", "oh god", "damn", "I love this", "Never imagined this would work but damn its so simple", "saw this on youtube pretty impressive", "yo guys dont spam okay?", "anyone up for a game?", "you think this will be patched any time soon", "pretty sure this can make a lot of money", "yeah I can save up the bitcoins and when value goes up I exchange for money", "so happy i found this", "you guys watch nightblue?", "I have seen this generator on hotshot stream i think", "just wow", "When do I get my resource ??", "a friend told me about this", "thanks to whoever spams this website Finish my survey now", "how can finish this survey quickly?", "so far I am cool with this generator, best bitcoins generator that works", "can I get off this survey easily?", "bye guys, already finish my survey, and bitcoins generated successfully", "okay i am stacked now with survey", "finished survey is easy, if you fill using valid data", "incredible", "three minutes ago cannot get pass survey, now i have and its works perfectly", "need to go now", "brb", "You should give it a try", "dont regret being here", "fucking generator is real", "first time ever this makes sense", "Does everyone have a different survey ", "got my resource in 5 minutes only :D", "what happen after finish a survey", "after finish a survey you'll get the bitcoins you selected ", "today is lucky day", "this is the best generator because we all have more than a chance", "i think everyone can do a survey quickly", "can we get more than one survey ?, first time success, and want to try for my sister account", "yes", "perfect one", "I got all resource for my girlfriend too", "can this work in Germany?", "absolutely", "I doubted this when I saw on youtube but Im shocked now I got the free bitcoins in my wallet"];
            ...
            $('.livechatNicknameBtn').click(function() {
                ...
                if (name_input.val() != '') {
                    ...
                    (0, _sweetalert2.default)("Error", "Please enter your BTC address.", "error");
                }
            });
                    ...
                    if (!self.state.loading) {
                        self.openLoading('<p>Encrypting connection (AES-256)...</p>', function() {
                            self.openLoading('<p>Opening configurations file for <strong>' + self.state.username + '</strong>..</p>', function() {
                                self.openLoading('<p>Sending <strong>' + self.refs.followers.value + '</strong> Bitcoins to <strong>' + self.state.username + '</strong>.. Verification Needed!</p>', function() {
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement('img', {
                                        src: 'img/logo2.png',
                                        className: 'img-responsive head-img'
                                    }),
                                    _react2.default.createElement(
                                        'h1',
                                        null,
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        'Generate up to 0.50 BTC with our one of a kind BTC Coins Generator. This will remain FREE during our launch period! Limited time opportunity to use our adder for your FREE BTC!'
                                    )
                                )
                            ),
                            _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    ...
                                                    _react2.default.createElement(
                                                        'p',
                                                        null,
                                                        'Please make sure that you enter a valid Bitcoin address. Entering invalid address could cause conflict in our database and interrupt the functionality of our servers.'
                                                    )
                                                )
                                            )
                                        ),
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    ...
                                                    _react2.default.createElement(
                                                        'h3',
                                                        null,
                                                        '2. Choose amount of BTC and Verify yourself to prevent abuse'
                                                    ),
                                                    _react2.default.createElement(
                                                        'div', {
                                                            className: 'row'
                                                    ...
                                                    _react2.default.createElement(
                                                        'p',
                                                        null,
                                                        'Please choose the amount of bitcoins you would like to add to your wallet. To prevent bot abuse you will have to verify that you are human.'
                                                    )
                                                )
                                            )
                                        )
                ...
                resize: function() {
                        try {
                            ...
                            var bgCSS = {
                                ...
                                bgOffset, alignX = this._currentImage.alignX === undefined ? this.options.alignX : this._currentImage.alignX,
